...
export default function AuthPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      const endpoint = isLogin ? '/api/login' : `${process.env.NEXT_PUBLIC_API_URL}/api/admin/adminSignup`;
      ...
      await Swal.fire({
        icon: "success",
        text: isLogin ? "Login Successfully" : "Registration Successful",
        showConfirmButton: false,
        timer: 2000,
      });
      ...
      await Swal.fire({
        icon: "error",
        text: error instanceof Error ? error.message : `${isLogin ? 'Login' : 'Registration'} failed`,
        showConfirmButton: false,
        timer: 2000,
      });
    } finally {
